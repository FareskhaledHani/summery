...
part of 'chalet_details_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChaletDetailsState);
}
...
/// @nodoc
class $ChaletDetailsStateCopyWith<$Res>  {
$ChaletDetailsStateCopyWith(ChaletDetailsState _, $Res Function(ChaletDetailsState) __);
}


/// Adds pattern-matching-related methods to [ChaletDetailsState].
extension ChaletDetailsStatePatterns on ChaletDetailsState {
...
class _Initial implements ChaletDetailsState {
  const _Initial();
...
@override
String toString() {
  return 'ChaletDetailsState.initial()';
}
...
class _Loading implements ChaletDetailsState {
  const _Loading();
...
@override
String toString() {
  return 'ChaletDetailsState.loading()';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $ChaletDetailsStateCopyWith<$Res> {
...
class _Error implements ChaletDetailsState {
...
@override
String toString() {
  return 'ChaletDetailsState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $ChaletDetailsStateCopyWith<$Res> {
